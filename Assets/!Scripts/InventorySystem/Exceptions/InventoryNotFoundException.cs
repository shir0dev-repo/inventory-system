namespace Shir0.InventorySystem
{
    ...
    ///         <see langword="throw new"/> <see cref="InventoryNotFoundException"/>("Inventory cannot be null!");
    ///     <see langword="else if"/> (<paramref name="inventory"/>.Slots == <see langword="null"/>)<br/>
    ///         <see langword="throw new"/> <see cref="InventoryNotFoundException"/>("Inventory slots cannot be null!");
    /// </code></example>
    /// </remarks>
